...
namespace Common
{
    public class TilemapInputService : ITilemapInput, IInitializable, IDisposable, ITickable
    {
        ...
        public TilemapInputService(ITilemapPositionConverter tilemapPositionConverter)
        {
